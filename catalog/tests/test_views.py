...
class AuthorListViewTest(TestCase):
    """Unit test view class AuthorListViewTest. Component test for author list view objects."""
    @classmethod
    ...
    def test_lists_all_authors(self):
        ...
        self.assertFalse(len(response.context['author_list']) == 9)


class LoanedBookInstancesByUserListViewTest(TestCase):
    """
    Unit test view class LoanedBookInstancesByUserListViewTest. 
    Component test for loaned book instances by user list view objects.
    """
    def setUp(self):
        # Create two users
        ...
        # Create a book
        test_author = Author.objects.create(first_name = 'John', surname = 'Smith')
...
class RenewBookInstancesViewTest(TestCase):
    """
    Unit test view class RenewBookInstancesViewTest. 
    Component test for permission required to access the view by user objects to renew book instances.
    """
    def setUp(self):
        # Create a user
        test_user1 = User.objects.create_user(username = 'testuser1', password = '1X<ISRUkw+tuK')
...
class AuthorCreateViewTest(TestCase):
    """
    Unit test view class AuthorCreateViewTest. 
    Component test for author objects to create book instances.
    """
    def setUp(self):
        # Create a user
        test_user1 = User.objects.create_user(username = 'testuser1', password = '1X<ISRUkw+tuK')
    ...
    def test_redirects_to_detail_view_on_success(self):
        ...
        response = self.client.post(reverse('author-create'),
                                    {'first_name': 'Christian', 'surname': 'Surname Name'})
